namespace GigHub.Migrations
{
    ...
    public partial class OverrideConventionsForGigsAndGenres : DbMigration
    {
        ...
        {
            DropForeignKey("dbo.Gigs", "Artist_Id", "dbo.Users");
            ...
            AddForeignKey("dbo.Gigs", "Artist_Id", "dbo.Users", "Id", cascadeDelete: true);
        ...
        public override void Down()
        {
            ...
            AddForeignKey("dbo.Gigs", "Artist_Id", "dbo.Users", "Id");
        }
    }
}
